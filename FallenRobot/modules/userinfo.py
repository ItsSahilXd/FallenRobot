...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nᴛʜᴇ ʀᴀɴᴋ ᴏғ ᴛʜɪs ᴜsᴇʀ ɪs <b>ᴄᴀᴘᴛᴀɪɴ</b>.\n"
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nᴛʜɪs ᴜsᴇʀ ɪs ᴀ <b>sᴡᴏʀᴅsᴍᴀɴ</b>.\n"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nᴛʜᴇ ʀᴀɴᴋ ᴏғ ᴛʜɪs ᴜsᴇʀ ɪs <b>ɴᴀᴠɪɢᴀᴛᴏʀ</b>.\n"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nᴛʜᴇ ʀᴀɴᴋ ᴏғ ᴛʜɪs ᴜsᴇʀ ɪs <b>sɴɪᴘᴇʀ</b>.\n"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nᴛʜᴇ ʀᴀɴᴋ ᴏғ ᴛʜɪs ᴜsᴇʀ ɪs <b>ᴅᴏᴄᴛᴏʀ</b>.\n"
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nᴛʜᴇ ʀᴀɴᴋ ᴏғ ᴛʜɪs ᴜsᴇʀ ɪs <b>ᴄᴏᴏᴋ</b>.\n"
        disaster_level_present = True

    if disaster_level_present:
        text += ' \n[<a href="https://t.me/nico_robin_updates/15">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
